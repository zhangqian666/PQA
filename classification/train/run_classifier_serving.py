...
class PoetryProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        return ["UpAndDownSentences_simple", "CottonWadOrder_simple", "FillInTheWords_simple", "ErrorCorrection_simple",
